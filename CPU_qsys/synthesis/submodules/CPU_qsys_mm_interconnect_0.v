// CPU_qsys_mm_interconnect_0.v

// This file was auto-generated from altera_merlin_interconnect_wrapper_hw.tcl.  If you edit it your changes
// will probably be lost.
// 
// Generated using ACDS version 13.1 162 at 2018.01.23.14:20:52

`timescale 1 ps / 1 ps
module CPU_qsys_mm_interconnect_0 (
	...
	wire  [103:0] uart_s1_translator_avalon_universal_slave_0_agent_rf_source_data;                                 // UART_s1_translator_avalon_universal_slave_0_agent:rf_source_data -> UART_s1_translator_avalon_universal_slave_0_agent_rsp_fifo:in_data
	...
	wire  [103:0] uart_s1_translator_avalon_universal_slave_0_agent_rsp_fifo_out_data;                              // UART_s1_translator_avalon_universal_slave_0_agent_rsp_fifo:out_data -> UART_s1_translator_avalon_universal_slave_0_agent:rf_sink_data
	...
	wire  [102:0] cmd_xbar_mux_002_src_data;                                                                        // cmd_xbar_mux_002:src_data -> UART_s1_translator_avalon_universal_slave_0_agent:cp_data
	...
	wire  [102:0] cmd_xbar_mux_003_src_data;                                                                        // cmd_xbar_mux_003:src_data -> JTAG_UART_avalon_jtag_slave_translator_avalon_universal_slave_0_agent:cp_data
	...
	wire  [102:0] cmd_xbar_mux_004_src_data;                                                                        // cmd_xbar_mux_004:src_data -> sysid_qsys_control_slave_translator_avalon_universal_slave_0_agent:cp_data
	...
	wire  [102:0] uart_s1_translator_avalon_universal_slave_0_agent_rp_data;                                        // UART_s1_translator_avalon_universal_slave_0_agent:rp_data -> id_router_002:sink_data
	...
	wire  [102:0] sysid_qsys_control_slave_translator_avalon_universal_slave_0_agent_rp_data;                       // sysid_qsys_control_slave_translator_avalon_universal_slave_0_agent:rp_data -> id_router_004:sink_data
	...
	wire   [84:0] id_router_001_src_data;                                                                           // id_router_001:src_data -> width_adapter:in_data
	...
	wire  [102:0] width_adapter_src_data;                                                                           // width_adapter:out_data -> rsp_xbar_demux_001:sink_data
	...
	wire  [102:0] cmd_xbar_mux_001_src_data;                                                                        // cmd_xbar_mux_001:src_data -> width_adapter_001:in_data
	wire    [4:0] cmd_xbar_mux_001_src_channel;                                                                     // cmd_xbar_mux_001:src_channel -> width_adapter_001:in_channel
	...
	CPU_qsys_mm_interconnect_0_addr_router addr_router (
	...
	CPU_qsys_mm_interconnect_0_addr_router_001 addr_router_001 (
	...
	CPU_qsys_mm_interconnect_0_id_router id_router (
	...
	CPU_qsys_mm_interconnect_0_id_router_001 id_router_001 (
	...
	CPU_qsys_mm_interconnect_0_id_router_002 id_router_002 (
	...
	CPU_qsys_mm_interconnect_0_id_router_002 id_router_003 (
	...
	CPU_qsys_mm_interconnect_0_id_router_002 id_router_004 (
	...
	CPU_qsys_mm_interconnect_0_cmd_xbar_demux cmd_xbar_demux (
		.clk                (CLK_clk_clk),                             //        clk.clk
		.reset              (CPU_reset_n_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	CPU_qsys_mm_interconnect_0_cmd_xbar_demux_001 cmd_xbar_demux_001 (
		.clk                (CLK_clk_clk),                             //        clk.clk
		.reset              (CPU_reset_n_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	CPU_qsys_mm_interconnect_0_cmd_xbar_mux cmd_xbar_mux (
		.clk                 (CLK_clk_clk),                             //       clk.clk
		.reset               (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CPU_qsys_mm_interconnect_0_cmd_xbar_mux cmd_xbar_mux_001 (
		.clk                 (CLK_clk_clk),                             //       clk.clk
		.reset               (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CPU_qsys_mm_interconnect_0_cmd_xbar_mux_002 cmd_xbar_mux_002 (
		.clk                 (CLK_clk_clk),                             //       clk.clk
		.reset               (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CPU_qsys_mm_interconnect_0_cmd_xbar_mux_002 cmd_xbar_mux_003 (
		.clk                 (CLK_clk_clk),                             //       clk.clk
		.reset               (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CPU_qsys_mm_interconnect_0_cmd_xbar_mux_002 cmd_xbar_mux_004 (
		.clk                 (CLK_clk_clk),                             //       clk.clk
		.reset               (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CPU_qsys_mm_interconnect_0_rsp_xbar_demux rsp_xbar_demux (
		.clk                (CLK_clk_clk),                             //       clk.clk
		.reset              (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CPU_qsys_mm_interconnect_0_rsp_xbar_demux rsp_xbar_demux_001 (
		.clk                (CLK_clk_clk),                             //       clk.clk
		.reset              (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CPU_qsys_mm_interconnect_0_rsp_xbar_demux_002 rsp_xbar_demux_002 (
		.clk                (CLK_clk_clk),                             //       clk.clk
		.reset              (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CPU_qsys_mm_interconnect_0_rsp_xbar_demux_002 rsp_xbar_demux_003 (
		.clk                (CLK_clk_clk),                             //       clk.clk
		.reset              (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CPU_qsys_mm_interconnect_0_rsp_xbar_demux_002 rsp_xbar_demux_004 (
		.clk                (CLK_clk_clk),                             //       clk.clk
		.reset              (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CPU_qsys_mm_interconnect_0_rsp_xbar_mux rsp_xbar_mux (
		.clk                 (CLK_clk_clk),                             //       clk.clk
		.reset               (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CPU_qsys_mm_interconnect_0_rsp_xbar_mux_001 rsp_xbar_mux_001 (
		.clk                 (CLK_clk_clk),                             //       clk.clk
		.reset               (CPU_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
